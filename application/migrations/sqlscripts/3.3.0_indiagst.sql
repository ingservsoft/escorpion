...
RENAME TABLE `qc_tax_codes` TO `qc_tax_codes_backup`;
...
RENAME TABLE `qc_sales_taxes` TO `qc_sales_taxes_backup`;
...
CREATE TABLE IF NOT EXISTS `qc_tax_jurisdictions` (
...
RENAME TABLE `qc_tax_code_rates` TO `qc_tax_code_rates_backup`;

CREATE TABLE IF NOT EXISTS `qc_tax_rates` (
