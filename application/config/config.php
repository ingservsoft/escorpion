...
| 
*/ 
$config['application_version'] = '24.8';
...
| 
*/ 
$config['commit_sha1'] = 'bb309c';
 
/* 
|-------------------------------------------------------------------------- 
| Internal to QuieroCancha XSS Clean 
|-------------------------------------------------------------------------- 
| 
...
|
*/
$config['encryption_key'] = getenv('ENCRYPTION_KEY') ? getenv('ENCRYPTION_KEY') : 'M4R10*4LB3RT0*L4RR4N4G4*C45TR0';
