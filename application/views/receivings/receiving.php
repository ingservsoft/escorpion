	...
	<?php echo form_open($controller_name."/change_mode", array('id'=>'mode_form', 'class'=>'form-horizontal panel panel-default')); ?>
		<div class="panel-body form-group">
			<ul>
				...
				?>
                <li class="pull-right">
					<button class='btn btn-default btn-sm modal-dlg' id='show_suspended_receiving_button' data-href="<?php echo site_url($controller_name."/suspended"); ?>"
							title="<?php echo $this->lang->line('cuentas_por_pagar'); ?>">
						<span class="glyphicon glyphicon-align-justify">&nbsp</span><?php echo $this->lang->line('cuentas_por_pagar'); ?>
					</button>
				</li>
				...
				?>
					<li class="pull-right">
						<?php echo anchor($controller_name."/manage", '<span class="glyphicon glyphicon-list-alt">&nbsp</span>' . $this->lang->line('receivings_takings'),
									array('class'=>'btn btn-primary btn-sm', 'id'=>'sales_takings_button', 'title'=>$this->lang->line('receivings_takings'))); ?>
					</li>
				<?php
				}
				?>
					...
					<?php echo form_open($controller_name."/complete", array('id'=>'finish_receiving_form', 'class'=>'form-horizontal')); ?>
						<div class="form-group form-group-sm">
							...
							<div id="payment_details" >
								<table class="sales_table_100" >
									<tr>
										<td><?php echo $this->lang->line('receivings_print_after_receiving'); ?></td>
										<td>
											<?php echo form_checkbox(array('name'=>'recv_print_after_receiving', 'id'=>'recv_print_after_receiving', 'class'=>'checkbox', 'value'=>1, 'checked'=>$print_after_sale)); ?>
										</td>
									</tr>
									<?php
									if ($mode == "receive")
									...
									<tr>
										<td><?php echo $this->lang->line('receivings_amount_tendered'); ?></td>
										<td>
							...
							<div class='btn btn-sm btn-primary pull-left' id='suspend_receiving_button'><span class="glyphicon glyphicon-align-justify">&nbsp;</span><?php echo $this->lang->line('receivings_suspend_receivings'); ?></div>				
...
$(document).ready(function()
{
	...
	$("#recv_print_after_receiving").change(function()
	{
		$.post('<?php echo site_url($controller_name."/set_print_after_sale");?>', {recv_print_after_receiving: $(this).is(":checked")});
	});
	...
	$("#suspend_receiving_button").click(function()
	{
		$('#finish_receiving_form').attr('action', "<?php echo site_url($controller_name."/suspend"); ?>");
		$('#finish_receiving_form').submit();
	});
});
