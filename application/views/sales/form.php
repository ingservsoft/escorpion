...
?>
		...
		<div class="form-group form-group-sm">
			<a class="btn btn-warning" href="<?php echo site_url('sales/unsuspend_retomada/'.$sale_info['sale_id'].'/Efectivo/'.$saldo.'/'.$sale_info['sale_time'].'/'.COMPLETED)?>">Retomar</a>
		</div>
	</fieldset>
<?php echo form_close(); ?>
...
function retomar_reserva(){
	$.ajax({
		url: "<?php echo site_url('sales/unsuspend'); ?>",
		type: 'POST',
		data:{
			sale_id:<?php echo $sale_info['sale_id'];?>,
		},
