...
<head>
	...
	<title><?php echo $this->config->item('company') . ' | ' . $this->lang->line('common_powered_by') . ' QuieroCancha ' . $this->config->item('application_version') ?></title>
	...
	<?php if ($this->input->cookie('debug') == 'true' || $this->input->get('debug') == 'true') : ?>
		...
		<link rel="stylesheet" type="text/css" href="css/ospos_print.css?<?php echo time();?>"/>
		...
		<div class="navbar navbar-default" role="navigation">
			<div class="container">
				<div class="navbar-header" style="margin-bottom: 20px">
					...
					<a href="<?php echo site_url(); ?>"><img src="<?php echo base_url() . 'images/quierocancha.png'?>" width="70%" /></a>
				</div>
