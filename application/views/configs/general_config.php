<?php echo form_open('config/save_general/', array('id' => 'general_config_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal')); ?>
	<div id="config_wrapper">
		<fieldset id="config_info">
			...
			<div class="form-group form-group-sm">
				<?php echo form_label('Permitir Ventas Sin Stock', 'ventas_sin_stock', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-1'>
					<?php echo form_checkbox(array(
					'name' => 'ventas_sin_stock',
					'id' => 'ventas_sin_stock',
					'value' => '1',
					'checked' => $this->config->item('ventas_sin_stock'))); ?>
					&nbsp
					<label class="control-label">
						<span class="glyphicon glyphicon-info-sign" data-toggle="tooltip" data-placement="right" title="Permitir Ventas Sin Stock (Pueden aparecer cantidades en negativo)"></span>
					</label>
				</div>
			</div>
