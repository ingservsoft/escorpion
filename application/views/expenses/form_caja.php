...
<?php echo form_open('expenses_caja/save/'.$expenses_info->expense_id, array('id'=>'expenses_edit_form', 'class'=>'form-horizontal')); ?>
	<fieldset id="item_basic_info">
        ...
        <div class="form-group form-group-sm">
			<?php echo form_label("Tipo Movimiento", 'tipo_movimiento', array('class'=>'required control-label col-xs-3')); ?>
			<div class='col-xs-6'>
				<?php //echo form_dropdown('tipo_movimiento', $tipo_movimiento_options, $expenses_info->tipo_movimiento, array('class'=>'form-control', 'id'=>'payment_type'));?>
				<select name="tipo_movimiento" id="tipo_movimiento" class="form-control">
                	<option value="">Seleccione...</option>
                    <option value="Egreso" <?php if($expenses_info->tipo_movimiento=='Egreso') echo 'selected="selected"';?>>Egreso</option>
                    <option value="Ingreso" <?php if($expenses_info->tipo_movimiento=='Ingreso') echo 'selected="selected"';?>>Ingreso</option>
                </select>
            </div>
		</div>
        ...
        <div class="form-group form-group-sm" style="display: none;">
			<?php echo form_label("Caja", 'caja', array('class'=>'required control-label col-xs-3')); ?>
			<div class='col-xs-6'>				
				<!--select name="caja" id="caja" class="form-control">
                	<option value="">Seleccione...</option>
                    <option value="Caja POS" <?php if($expenses_info->caja=='Caja POS') echo 'selected="selected"';?>>Caja POS</option>
                    <option value="Caja General" <?php if($expenses_info->caja=='Caja General') echo 'selected="selected"';?>>Caja General</option>
                </select-->
				<select name="caja" id="caja" class="form-control">
                	<option value="">Seleccione...</option>
                    <option value="Caja POS" selected="selected">Caja POS</option>
                </select>
            </div>
		</div>
...
$(document).ready(function()
{
	...
	$('#expenses_edit_form').validate($.extend({
		...
		messages:
		{
			...
			tipo_movimiento:
			{
				required: "<?php echo "Seleccione un tipo de Movimiento"; ?>"
			},
			caja:
			{
				required: "<?php echo "Seleccione una Caja para el Movimiento"; ?>"
			}
		}
	}, form_support.error));
});
