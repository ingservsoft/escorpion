...
class Customers extends Persons
{
	...
	*/
	public function view($customer_id = -1,$origin='customer')
	{
	...
	*/
	...
	public function do_csv_import()
	{
		...
		/*
	AJAX call to verify if an phone_number address already exists carlos Chaucanes
	*/
	public function ajax_check_phone_number()
	{
		$exists = $this->Customer->check_phone_number_exists(strtolower($this->input->post('phone_number')), $this->input->post('person_id'));
