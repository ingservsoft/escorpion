...
class Config extends Secure_Controller
{
	...
	/*
	 * This function loads all the licenses starting with the first one being QuieroCancha one
	 */
	private function _licenses()
	{
		...
		{
			$license[$i]['text'] = 'LICENSE file must be in QuieroCancha license directory. You are not allowed to use QuieroCancha application until the distribution copy of LICENSE file is present.';
		}
	...
	public function save_general()
	{
		$batch_save_data = array(
			...
			'ventas_sin_stock' => $this->input->post('ventas_sin_stock')
		);
